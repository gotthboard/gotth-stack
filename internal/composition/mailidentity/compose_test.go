...
func TestProductionAddressAndReservedZoneValidation(t *testing.T) {
	for _, raw := range []string{"10.0.0.1", "100.64.0.1", "192.0.0.1", "198.18.0.1", "203.0.113.1", "224.0.0.1", "::ffff:10.0.0.1", "::ffff:8.8.8.8", "64:ff9b::1", "100:0:0:1::1", "2001::1", "2001:db8::1", "2002::1", "2606:4700:4700::1111%eth0", "3fff::1", "5f00::1", "fc00::1"} {
