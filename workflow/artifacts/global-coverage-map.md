...
| platform adapters | critical | disposable runtime, rollback | Caddy 81.8%, PostgreSQL 79.4%, and Authentik 72.8%; each has 100 race repeats, 20 shuffled runs, reopen, managed replacement, reverse rollback, and real disposable runtime proof | defensive direct-OS failures, fixed-struct marshal impossibilities, and redundant rejection branches are not line-covered; component-scoped execution grants and controller apply remain blocked |
