...
| platform adapters | critical | disposable runtime, rollback | Caddy admitted at Forgejo PR #4 with 81.8% coverage; PostgreSQL candidate has 79.5% coverage, 100 race repeats, 20 shuffled runs, fresh and two-digest PostgreSQL 17 replacement/reopen/rollback proof | defensive direct-OS cleanup failures and fixed-struct marshal impossibilities are not line-covered; Authentik remains unimplemented; parent workstream and apply remain blocked |
