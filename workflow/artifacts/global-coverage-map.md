...
| platform adapters | critical | disposable runtime, rollback | Caddy child verified candidate: 81.8% statement coverage, 100 race repeats, 20 shuffled race runs, checkpoint injection, and disposable Caddy 2.11.4 install/reopen/rollback proof | direct OS failures and fixed-struct marshal impossibilities are not line-covered; Authentik and PostgreSQL remain unimplemented; parent workstream and apply remain blocked |
