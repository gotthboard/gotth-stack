...
| durable journal and recovery | critical | binding, crash, filesystem fault, corruption, lock, replay, state machine, boundary, fuzz | contract active on `1.0.0-alpha.N`; implementation evidence pending | blocks apply; no exception |
